...
function q$1(a, b, c) {
  Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? q$1 = ha : q$1 = ia;
...
var Ha = w(x$2, "Opera"),
    y$1 = w(x$2, "Trident") || w(x$2, "MSIE"),
    Ia = w(x$2, "Edge"),
    Ja = Ia || y$1,
    Ka = w(x$2, "Gecko") && !(w(x$2.toLowerCase(), "webkit") && !w(x$2, "Edge")) && !(w(x$2, "Trident") || w(x$2, "MSIE")) && !w(x$2, "Edge"),
    La = w(x$2.toLowerCase(), "webkit") && !w(x$2, "Edge");
...
function fb(a, b, c, d, e) {
  ...
  c = hb(c);
  return a && a[B$1] ? a.N(b, c, p$1(d) ? !!d.capture : !!d, e) : ib(a, b, c, !1, d, e);
}
...
function gb(a, b, c, d, e) {
  ...
  c = hb(c);
  return a && a[B$1] ? a.O(b, c, p$1(d) ? !!d.capture : !!d, e) : ib(a, b, c, !0, d, e);
}

function nb(a, b, c, d, e) {
  if (Array.isArray(b)) for (var f = 0; f < b.length; f++) {
    nb(a, b[f], c, d, e);
  } else (d = p$1(d) ? !!d.capture : !!d, c = hb(c), a && a[B$1]) ? (a = a.i, b = String(b).toString(), b in a.g && (f = a.g[b], c = ab(f, c, d, e), -1 < c && (Za(f[c]), Array.prototype.splice.call(f, c, 1), 0 == f.length && (delete a.g[b], a.h--)))) : a && (a = jb(a)) && (b = a.g[b.toString()], a = -1, b && (a = ab(b, c, d, e)), (c = -1 < a ? b[a] : null) && ob(c));
}
...
function D$2(a, b) {
  ...
  a = a.P;
  d = b.type || b;
  if ("string" === typeof b) b = new z$2(b, a);else if (b instanceof z$2) b.target = b.target || a;else {
    var e = b;
    b = new z$2(d, a);
    Aa$1(b, e);
  }
...
k$1.kb = function () {
  if (this.da) {
    ...
    0 < a && a < .8 * this.h ? this.S = this.g.setTimeout(this.j, this.h - a) : (this.S && (this.g.clearTimeout(this.S), this.S = null), D$2(this, "tick"), this.da && (Fb(this), this.start()));
  }
};
...
function Ub(a, b) {
  z$2.call(this, H$1.STAT_EVENT, a);
  this.stat = b;
}
      ...
      if (!(3 > r) && (3 != r || Ja || this.g && (this.h.h || this.g.ga() || oc(this.g)))) {
        ...
        if (this.i) {
          if (this.$ && !this.J) {
            ...
            if (c = m) F$2(this.j, this.m, c, "Initial handshake response via X-HTTP-Initial-Response"), this.J = !0, sc(this, c);else {
              this.i = !1;
              this.o = 3;
              J$2(12);
              P$1(this);
          ...
          this.U ? (tc(this, r, h), Ja && this.i && 3 == r && (Kb(this.V, this.W, "tick", this.fb), this.W.start())) : (F$2(this.j, this.m, h, null), sc(this, h));
          4 == r && P$1(this);
          this.i && !this.I && (4 == r ? uc(this.l, this) : (this.i = !1, lc(this)));
        } else 400 == c && 0 < h.indexOf("Unknown SID") ? (this.o = 3, J$2(12)) : (this.o = 0, J$2(13)), P$1(this), rc(this);
      }
    }
  } catch (r) {} finally {}
};
...
function tc(a, b, c) {
  ...
  for (; !a.I && a.C < c.length;) {
    if (e = vc(a, c), e == hc) {
      4 == b && (a.o = 4, J$2(14), d = !1);
      F$2(a.j, a.m, null, "[Incomplete Response]");
      break;
    } else if (e == gc) {
      a.o = 4;
      J$2(15);
      F$2(a.j, a.m, c, "[Invalid Chunk]");
      d = !1;
      break;
    } else F$2(a.j, a.m, e, null), sc(a, e);
  }

  qc(a) && e != hc && e != gc && (a.h.g = "", a.C = 0);
  4 != b || 0 != c.length || a.h.h || (a.o = 1, J$2(16), d = !1);
  a.i = a.i && d;
  d ? 0 < c.length && !a.aa && (a.aa = !0, b = a.l, b.g == a && b.$ && !b.L && (b.h.info("Great, no buffering proxy detected. Bytes received: " + c.length), wc(b), b.L = !0, J$2(11))) : (F$2(a.j, a.m, c, "[Invalid Chunked Response]"), P$1(a), rc(a));
}
...
k$1.eb = function () {
  this.B = null;
  var a = Date.now();
  0 <= a - this.Y ? (Qb(this.j, this.A), 2 != this.K && (I$1(), J$2(17)), P$1(this), this.o = 2, rc(this)) : xc(this, this.Y - a);
};
  ...
  try {
    ...
    if (0 != c.G && (c.g == a || yc(c.i, a))) if (c.I = a.N, !a.J && yc(c.i, a) && 3 == c.G) {
      ...
      if (Array.isArray(d) && 3 == d.length) {
        ...
        if (0 == e[0]) a: {
          if (!c.u) {
            if (c.g) if (c.g.F + 3E3 < a.F) zc$1(c), Ac(c);else break a;
            Bc(c);
            J$2(18);
          }
    ...
    } else if ((a.J || c.g == a) && zc$1(c), !sa(b)) for (e = c.Ca.g.parse(b), b = 0; b < e.length; b++) {
      var m = e[b];
      c.U = m[0];
      m = m[1];
      if (2 == c.G) {
        if ("c" == m[0]) {
          ...
          0 < c.l.length && Hc(c);
        } else "stop" != m[0] && "close" != m[0] || Q$2(c, 7);
      } else 3 == c.G && ("stop" == m[0] || "close" == m[0] ? "stop" == m[0] ? Q$2(c, 7) : Ic(c) : "noop" != m[0] && c.j && c.j.wa(m), c.A = 0);
    }
    I$1(4);
  } catch (m) {}
}
...
function Lc(a) {
  ...
  if (a.i != a.g.length) {
    ...
    for (c = b = 0; b < a.g.length;) {
      d = a.g[b], T$1(e, d) || (a.g[c++] = d, e[d] = 1), b++;
    }
...
k$1.get = function (a, b) {
  return T$1(this.h, a) ? this.h[a] : b;
};

k$1.set = function (a, b) {
  T$1(this.h, a) || (this.i++, this.g.push(a));
  this.h[a] = b;
};
...
U$2.prototype.toString = function () {
  var a = [],
      b = this.j;
  b && a.push(Uc(b, Vc, !0), ":");
  var c = this.i;
...
function ad(a) {
  return a instanceof U$2 ? N$2(a) : new U$2(a, void 0);
}

function bd(a, b, c, d) {
  var e = new U$2(null, void 0);
  a && Oc(e, a);
  b && Pc(e, b);
  c && Qc(e, c);
  d && (e.l = d);
...
function dd(a, b) {
  V(a);
  b = W$2(a, b);
  T$1(a.g.h, b) && (a.i = null, a.h -= a.g.get(b).length, a = a.g, T$1(a.h, b) && (delete a.h[b], a.i--, a.g.length > 2 * a.i && Lc(a)));
}
...
k$1.R = function (a) {
  V(this);
  var b = [];
  if ("string" === typeof a) ed(this, a) && (b = qa(b, this.g.get(W$2(this, a))));else {
    a = this.g.R();
...
function mc(a, b, c) {
  dd(a, b);
  0 < c.length && (a.i = null, a.g.set(W$2(a, b), ra(c)), a.h += c.length);
}
...
function gd(a) {
  this.l = a || hd;
  l$1.PerformanceNavigationTiming ? (a = l$1.performance.getEntriesByType("navigation"), a = 0 < a.length && ("hq" == a[0].nextHopProtocol || "h2" == a[0].nextHopProtocol)) : a = !!(l$1.g && l$1.g.Ea && l$1.g.Ea() && l$1.g.Ea().Zb);
  this.j = a ? this.l : 1;
  this.g = null;
...
k$1.send = function (a) {
  ...
  a && (b.body = a);
  (this.D || l$1).fetch(new Request(this.B, b)).then(this.Va.bind(this), this.ha.bind(this));
};
...
function Bd(a) {
  return y$1 && Ra() && "number" === typeof a.timeout && void 0 !== a.ontimeout;
}
...
k$1.pa = function () {
  "undefined" != typeof goog && this.g && (this.j = "Timed out after " + this.B + "ms, aborting", this.m = 8, D$2(this, "timeout"), this.abort(8));
};
...
function Cd(a) {
  a.D || (a.D = !0, D$2(a, "complete"), D$2(a, "error"));
}

k$1.abort = function (a) {
  this.g && this.h && (this.h = !1, this.l = !0, this.g.abort(), this.l = !1, this.m = a || 7, D$2(this, "complete"), D$2(this, "abort"), Dd(this));
};
...
function Ed(a) {
  if (a.h && "undefined" != typeof goog && (!a.C[1] || 4 != O$1(a) || 2 != a.ba())) if (a.v && 4 == O$1(a)) Gb(a.Fa, 0, a);else if (D$2(a, "readystatechange"), 4 == O$1(a)) {
    a.h = !1;
    ...
    try {
      ...
      if (c) D$2(a, "complete"), D$2(a, "success");else {
        a.m = 6;
...
k$1.Ha = function (a) {
  if (this.m) if (this.m = null, 1 == this.G) {
    if (!a) {
      ...
      this.ja ? (R$1(c, "$req", b), R$1(c, "SID", "null"), e.$ = !0, ic(e, c, null)) : ic(e, c, b);
      this.G = 2;
    }
...
k$1.bb = function () {
  this.B && (this.B = null, this.h.info("BP detection timeout reached."), this.h.info("Buffering proxy detected and switch to long-polling!"), this.N = !1, this.L = !0, J$2(10), Ac(this), Rd(this));
};
...
k$1.ab = function () {
  null != this.v && (this.v = null, Ac(this), Bc(this), J$2(19));
};
...
function Q$2(a, b) {
  ...
  if (2 == b) {
    ...
    a.j && (c = null);
    var d = q$1(a.jb, a);
    c || (c = new U$2("//www.google.com/images/cleardot.gif"), l$1.location && "http" == l$1.location.protocol || Oc(c, "https"), jc(c));
    nd(c.toString(), d);
  } else J$2(2);
...
k$1.jb = function (a) {
  a ? (this.h.info("Successfully pinged google.com"), J$2(2)) : (this.h.info("Failed to ping google.com"), J$2(1));
};
...
Y$2.prototype.close = function () {
  Ic(this.g);
};

Y$2.prototype.u = function (a) {
  if ("string" === typeof a) {
    var b = {};
    b.__data__ = a;
    Md(this.g, b);
...
Z$2.prototype.xa = function () {
  D$2(this.g, "a");
};

Z$2.prototype.wa = function (a) {
  D$2(this.g, new Ud(a));
};

Z$2.prototype.va = function (a) {
  D$2(this.g, new Vd());
};

Z$2.prototype.ua = function () {
  D$2(this.g, "b");
};
Y$2.prototype.send = Y$2.prototype.u;
Y$2.prototype.open = Y$2.prototype.m;
Y$2.prototype.close = Y$2.prototype.close;
Wb.NO_ERROR = 0;
Wb.TIMEOUT = 8;
Wb.HTTP_ERROR = 6;
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var N$1=new Logger("@firebase/firestore");// Helper methods are needed because variables can't be exported as read/write
function M$1(t){if(N$1.logLevel<=LogLevel.DEBUG){for(var _len=arguments.length,e=new Array(_len>1?_len-1:0),_key=1;_key<_len;_key++){e[_key-1]=arguments[_key];}var n=e.map(B);N$1.debug.apply(N$1,["Firestore (".concat(x$1,"): ").concat(t)].concat(_toConsumableArray$1(n)));}}function F$1(t){if(N$1.logLevel<=LogLevel.ERROR){for(var _len2=arguments.length,e=new Array(_len2>1?_len2-1:0),_key2=1;_key2<_len2;_key2++){e[_key2-1]=arguments[_key2];}var n=e.map(B);N$1.error.apply(N$1,["Firestore (".concat(x$1,"): ").concat(t)].concat(_toConsumableArray$1(n)));}}/**
 ...
 */function L$1(){var t=arguments.length>0&&arguments[0]!==undefined?arguments[0]:"Unexpected state";// Log the failure in addition to throw an exception, just in case the
// exception is swallowed.
var e="FIRESTORE (".concat(x$1,") INTERNAL ASSERTION FAILED: ")+t;// NOTE: We don't use FirestoreError here because these are internal failures
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var G$1={// Causes are copied from:
...
/** Not an error; returned on success. */OK:"ok",/** The operation was cancelled (typically by the caller). */CANCELLED:"cancelled",/** Unknown error or an error from a different error domain. */UNKNOWN:"unknown",/**
     ...
     * See litmus test above for deciding between FAILED_PRECONDITION, ABORTED,
     * and UNAVAILABLE.
     */UNAVAILABLE:"unavailable",/** Unrecoverable data loss or corruption. */DATA_LOSS:"data-loss"};/** An error returned by a Firestore operation. */var Q$1=/*#__PURE__*/function(_FirebaseError){_inherits(Q,_FirebaseError);var _super=_createSuper$1(Q);/** @hideconstructor */function Q(/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var j$1=/*#__PURE__*/_createClass$1(function j(){var _this2=this;_classCallCheck$1(this,j);this.promise=new Promise(function(t,e){_this2.resolve=t,_this2.reject=e;});});/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var W$1=/*#__PURE__*/_createClass$1(function W(t,e){_classCallCheck$1(this,W);this.user=e,this.type="OAuth",this.headers=new Map(),this.headers.set("Authorization","Bearer ".concat(t));});/**
 * A CredentialsProvider that always yields an empty token.
 * @internal
 */var z$1=/*#__PURE__*/function(){function z(){_classCallCheck$1(this,z);}_createClass$1(z,[{key:"getToken",value:function getToken(){return Promise.resolve(null);}},{key:"invalidateToken",value:function invalidateToken(){}},{key:"start",value:function start(t,e){// Fire with initial user.
t.enqueueRetryable(function(){return e(C.UNAUTHENTICATED);});}},{key:"shutdown",value:function shutdown(){}}]);return z;}();var J$1=/*#__PURE__*/function(){function J(t){_classCallCheck$1(this,J);this.t=t,/** Tracks the current User. */this.currentUser=C.UNAUTHENTICATED,/**
...
M$1("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new j$1());}},0),r();}},{key:"getToken",value:function getToken(){var _this5=this;// Take note of the current value of the tokenCounter so that this method
...
_this5.i!==t?(M$1("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),_this5.getToken()):e?(U$1("string"==typeof e.accessToken),new W$1(e.accessToken,_this5.currentUser)):null);}):Promise.resolve(null);}},{key:"invalidateToken",value:function invalidateToken(){this.forceRefresh=!0;}},{key:"shutdown",value:function shutdown(){this.auth&&this.auth.removeAuthTokenListener(this.o);}// Auth.getUid() can return null even with a user logged in. It is because
// getUid() is synchronous, but the auth code populating Uid is asynchronous.
// This method should only be called in the AuthTokenListener callback
// to guarantee to get the actual user.
},{key:"u",value:function u(){var t=this.auth&&this.auth.getUid();return U$1(null===t||"string"==typeof t),new C(t);}}]);return J;}();/*
 * FirstPartyToken provides a fresh token each time its value
 * is requested, because if the token is too old, requests will be rejected.
 * Technically this may no longer be necessary since the SDK should gracefully
 * recover from unauthenticated errors (see b/33147818 for context), but it's
 * safer to keep the implementation as-is.
 */var Y$1=/*#__PURE__*/_createClass$1(function Y(t,e,n){_classCallCheck$1(this,Y);this.type="FirstParty",this.user=C.FIRST_PARTY,this.headers=new Map(),this.headers.set("X-Goog-AuthUser",e);var s=t.auth.getAuthHeaderValueForFirstParty([]);s&&this.headers.set("Authorization",s),n&&this.headers.set("X-Goog-Iam-Authorization-Token",n);});/*
 * Provides user credentials required for the Firestore JavaScript SDK
 * to authenticate the user, using technique that is only available
 * to applications hosted by Google.
 */var X$1=/*#__PURE__*/function(){function X(t,e,n){_classCallCheck$1(this,X);this.h=t,this.l=e,this.m=n;}_createClass$1(X,[{key:"getToken",value:function getToken(){return Promise.resolve(new Y$1(this.h,this.l,this.m));}},{key:"start",value:function start(t,e){// Fire with initial uid.
t.enqueueRetryable(function(){return e(C.FIRST_PARTY);});}},{key:"shutdown",value:function shutdown(){}},{key:"invalidateToken",value:function invalidateToken(){}}]);return X;}();var Z$1=/*#__PURE__*/_createClass$1(function Z(t){_classCallCheck$1(this,Z);this.value=t,this.type="AppCheck",this.headers=new Map(),t&&t.length>0&&this.headers.set("x-firebase-appcheck",this.value);});var tt$1=/*#__PURE__*/function(){function tt(t){_classCallCheck$1(this,tt);this.g=t,this.forceRefresh=!1,this.appCheck=null,this.p=null;}_createClass$1(tt,[{key:"start",value:function start(t,e){var _this6=this;var n=function n(t){null!=t.error&&M$1("FirebaseAppCheckTokenProvider","Error getting App Check token; using placeholder token instead. Error: ".concat(t.error.message));var n=t.token!==_this6.p;return _this6.p=t.token,M$1("FirebaseAppCheckTokenProvider","Received ".concat(n?"new":"existing"," token.")),n?e(t.token):Promise.resolve();};this.o=function(e){t.enqueueRetryable(function(){return n(e);});};var s=function s(t){M$1("FirebaseAppCheckTokenProvider","AppCheck detected"),_this6.appCheck=t,_this6.appCheck.addTokenListener(_this6.o);};this.g.onInit(function(t){return s(t);}),// Our users can initialize AppCheck after Firestore, so we give it
 ...
 */function nt$1(t){// Polyfills for IE and WebWorker by using `self` and `msCrypto` when `crypto` is not available.
...
var n="";for(;n.length<20;){var s=nt$1(40);for(var i=0;i<s.length;++i){// Only accept values that are [0, maxMultiple), this ensures they can
// be evenly mapped to indices of `chars` via a modulo operation.
n.length<20&&s[i]<e&&(n+=t.charAt(s[i]%t.length));}}return n;}}]);return st;}();function it$1(t,e){return t<e?-1:t>e?1:0;}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
// sequences (e.g. __id123__) and just passes them through raw (they exist
// for legacy reasons and should not be used frequently).
var e=[];for(var _len4=arguments.length,t=new Array(_len4),_key4=0;_key4<_len4;_key4++){t[_key4]=arguments[_key4];}for(var _i2=0,_t4=t;_i2<_t4.length;_i2++){var n=_t4[_i2];if(n.indexOf("//")>=0)throw new Q$1(G$1.INVALID_ARGUMENT,"Invalid segment (".concat(n,"). Paths must not contain // in them."));// Strip leading and traling slashed.
e.push.apply(e,_toConsumableArray$1(n.split("/").filter(function(t){return t.length>0;})));}return new ht(e);}},{key:"emptyPath",value:function emptyPath(){return new ht([]);}}]);return ht;}(at$1);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */ /**
 * @internal
 */var dt$1=/*#__PURE__*/function(){function dt(t){_classCallCheck$1(this,dt);this.path=t;}_createClass$1(dt,[{key:"collectionGroup",get:function get(){return this.path.popLast().lastSegment();}/** Returns true if the document is in the specified collectionId. */},{key:"hasCollectionId",value:function hasCollectionId(t){return this.path.length>=2&&this.path.get(this.path.length-2)===t;}/** Returns the collection group (i.e. the name of the parent collection) for this key. */},{key:"getCollectionGroup",value:function getCollectionGroup(){return this.path.get(this.path.length-2);}/** Returns the fully qualified path to the parent collection. */},{key:"getCollectionPath",value:function getCollectionPath(){return this.path.popLast();}},{key:"isEqual",value:function isEqual(t){return null!==t&&0===ht$1.comparator(this.path,t.path);}},{key:"toString",value:function toString(){return this.path.toString();}}],[{key:"fromPath",value:function fromPath(t){return new dt(ht$1.fromString(t));}},{key:"fromName",value:function fromName(t){return new dt(ht$1.fromString(t).popFirst(5));}},{key:"empty",value:function empty(){return new dt(ht$1.emptyPath());}},{key:"comparator",value:function comparator(t,e){return ht$1.comparator(t.path,e.path);}},{key:"isDocumentKey",value:function isDocumentKey(t){return t.length%2==0;}/**
     * Creates and returns a new document key with the given segments.
     *
     * @param segments - The segments of the path to the document
     * @returns A new instance of DocumentKey
     */},{key:"fromSegments",value:function fromSegments(t){return new dt(new ht$1(t.slice()));}}]);return dt;}();/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */var _t$1=/*#__PURE__*/_createClass$1(function _t(/**
 ...
 */_t$1.UNKNOWN_ID=-1;/** Verifies whether `e` is an IndexedDbTransactionError. */function Ct$1(t){// Use name equality, as instanceof checks on errors don't work with errors
// that wrap other errors.
return "IndexedDbTransactionError"===t.name;}var qt$1=/*#__PURE__*/function(){function qt(t,e){_classCallCheck$1(this,qt);this.comparator=t,this.root=e||Gt.EMPTY;}// Returns a copy of the map, with the specified key/value added or replaced.
...
},{key:"getIterator",value:function getIterator(){return new Kt$1(this.root,null,this.comparator,!1);}},{key:"getIteratorFrom",value:function getIteratorFrom(t){return new Kt$1(this.root,t,this.comparator,!1);}},{key:"getReverseIterator",value:function getReverseIterator(){return new Kt$1(this.root,null,this.comparator,!0);}},{key:"getReverseIteratorFrom",value:function getReverseIteratorFrom(t){return new Kt$1(this.root,t,this.comparator,!0);}}]);return qt;}();// end SortedMap
// An iterator over an LLRBNode.
var Kt$1=/*#__PURE__*/function(){function Kt(t,e,n,s){_classCallCheck$1(this,Kt);this.isReverse=s,this.nodeStack=[];var i=1;for(;!t.isEmpty();){if(i=e?n(t.key,e):1,// flip the comparison if we're going in reverse
...
},{key:"check",value:function check(){if(this.isRed()&&this.left.isRed())throw L$1();if(this.right.isRed())throw L$1();var t=this.left.check();if(t!==this.right.check())throw L$1();return t+(this.isRed()?0:1);}}]);return Gt;}();// end LLRBNode
...
function(){function _class(){_classCallCheck$1(this,_class);this.size=0;}_createClass$1(_class,[{key:"key",get:function get(){throw L$1();}},{key:"value",get:function get(){throw L$1();}},{key:"color",get:function get(){throw L$1();}},{key:"left",get:function get(){throw L$1();}},{key:"right",get:function get(){throw L$1();}// Returns a copy of the current node.
 ...
 * be equal!
 */var Qt$1=/*#__PURE__*/function(){function Qt(t){_classCallCheck$1(this,Qt);this.comparator=t,this.data=new qt$1(this.comparator);}_createClass$1(Qt,[{key:"has",value:function has(t){return null!==this.data.get(t);}},{key:"first",value:function first(){return this.data.minKey();}},{key:"last",value:function last(){return this.data.maxKey();}},{key:"size",get:function get(){return this.data.size;}},{key:"indexOf",value:function indexOf(t){return this.data.indexOf(t);}/** Iterates elements in order defined by "comparator" */},{key:"forEach",value:function forEach(t){this.data.inorderTraversal(function(e,n){return t(e),!1;});}/** Iterates over `elem`s such that: range[0] &lt;= elem &lt; range[1]. */},{key:"forEachInRange",value:function forEachInRange(t,e){var n=this.data.getIteratorFrom(t[0]);for(;n.hasNext();){var s=n.getNext();if(this.comparator(s.key,t[1])>=0)return;e(s.key);}}/**
...
(this.binaryString);}},{key:"approximateByteSize",value:function approximateByteSize(){return 2*this.binaryString.length;}},{key:"compareTo",value:function compareTo(t){return it$1(this.binaryString,t.binaryString);}},{key:"isEqual",value:function isEqual(t){return this.binaryString===t.binaryString;}}],[{key:"fromBase64String",value:function fromBase64String(t){var e=atob(t);return new Jt(e);}},{key:"fromUint8Array",value:function fromUint8Array(t){// TODO(indexing); Remove the copy of the byte string here as this method
 ...
 * @internal
 */var re=/*#__PURE__*/function(){function re(t,e){_classCallCheck$1(this,re);this.projectId=t,this.database=e||"(default)";}_createClass$1(re,[{key:"isDefaultDatabase",get:function get(){return "(default)"===this.database;}},{key:"isEqual",value:function isEqual(t){return t instanceof re&&t.projectId===this.projectId&&t.database===this.database;}}],[{key:"empty",value:function empty(){return new re("","");}}]);return re;}();/** Returns whether the value represents -0. */function ue(t){// Detect if the value is -0.0. Based on polyfill from
// https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/is
return 0===t&&1/t==-1/0;}/** Returns true if the Value represents the canonical {@link #MAX_VALUE} . */function be$1(t){return "__max__"===(((t.mapValue||{}).fields||{}).__type__||{}).stringValue;}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */new qt$1(dt$1.comparator);new qt$1(dt$1.comparator);new qt$1(dt$1.comparator);new Qt$1(dt$1.comparator);new Qt$1(it$1);/**
 * Because we store all the useful information for this store in the key,
 * there is no useful information to store as the value. The raw (unencoded)
 * path cannot be stored because IndexedDb doesn't store prototype
 * information.
 */var Di=["mutationQueues","mutations","documentMutations","remoteDocuments","targets","owner","targetGlobal","targetDocuments"].concat(["clientMetadata"]).concat(["remoteDocumentGlobal"]).concat(["collectionParents"]).concat(["bundles","namedQueries"]);[].concat(_toConsumableArray$1(Di),["documentOverlays"]);// Firestore was removed.
/** Firestore index value writer.  */var rr$1=/*#__PURE__*/function(){function rr(){_classCallCheck$1(this,rr);}// The write methods below short-circuit writing terminators for values
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ /** A mutation queue for a specific user, backed by IndexedDB. */Pr$1.DEFAULT_COLLECTION_PERCENTILE=10,Pr$1.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,Pr$1.DEFAULT=new Pr$1(41943040,Pr$1.DEFAULT_COLLECTION_PERCENTILE,Pr$1.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),Pr$1.DISABLED=new Pr$1(-1,0,0);/** The Platform's 'document' implementation or null if not available. */function eu(){// `document` is not always available, e.g. in ReactNative and WebWorkers.
 ...
 */var Aa=/*#__PURE__*/function(){/** @hideconstructor */function Aa(t,e,n){_classCallCheck$1(this,Aa);this._authCredentials=e,this._appCheckCredentials=n,/**
         ...
         */this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new Ea({}),this._settingsFrozen=!1,t instanceof re?this._databaseId=t:(this._app=t,this._databaseId=function(t){if(!Object.prototype.hasOwnProperty.apply(t.options,["projectId"]))throw new Q$1(G$1.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new re(t.options.projectId);}/**
 ...
 */(t));}/**
     ...
     * instance.
     */_createClass$1(Aa,[{key:"app",get:function get(){if(!this._app)throw new Q$1(G$1.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app;}},{key:"_initialized",get:function get(){return this._settingsFrozen;}},{key:"_terminated",get:function get(){return void 0!==this._terminateTask;}},{key:"_setSettings",value:function _setSettings(t){if(this._settingsFrozen)throw new Q$1(G$1.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new Ea(t),void 0!==t.credentials&&(this._authCredentials=function(t){if(!t)return new z$1();switch(t.type){case"gapi":var e=t.client;// Make sure this really is a Gapi client.
return U$1(!("object"!=_typeof(e)||null===e||!e.auth||!e.auth.getAuthHeaderValueForFirstParty)),new X$1(e,t.sessionIndex||"0",t.iamToken||null);case"provider":return t.client;default:throw new Q$1(G$1.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type");}}(t.credentials));}},{key:"_getSettings",value:function _getSettings(){return this._settings;}},{key:"_freezeSettings",value:function _freezeSettings(){return this._settingsFrozen=!0,this._settings;}},{key:"_delete",value:function _delete(){return this._terminateTask||(this._terminateTask=this._terminate()),this._terminateTask;}/** Returns a JSON-serializable representation of this `Firestore` instance. */},{key:"toJSON",value:function toJSON(){return {app:this._app,databaseId:this._databaseId,settings:this._settings};}/**
...
throw F$1("INTERNAL UNHANDLED ERROR: ",e),t;}).then(function(t){return _this193.Lc=!1,t;});});return this.Oc=e,e;}},{key:"enqueueAfterDelay",value:function enqueueAfterDelay(t,e,n){var _this194=this;this.Gc(),// Fast-forward delays for timerIds that have been overriden.
this.qc.indexOf(t)>-1&&(e=0);var s=$u.createAndSchedule(this,t,e,n,function(t){return _this194.Wc(t);});return this.$c.push(s),s;}},{key:"Gc",value:function Gc(){this.Bc&&L$1();}},{key:"verifyOperationInProgress",value:function verifyOperationInProgress(){}/**
     ...
     * exists.
     */},{key:"Hc",value:function Hc(t){var _iterator72=_createForOfIteratorHelper$1(this.$c),_step72;try{for(_iterator72.s();!(_step72=_iterator72.n()).done;){var e=_step72.value;if(e.timerId===t)return !0;}}catch(err){_iterator72.e(err);}finally{_iterator72.f();}return !1;}/**
...
_this195.$c.sort(function(t,e){return t.targetTimeMs-e.targetTimeMs;});var _iterator73=_createForOfIteratorHelper$1(_this195.$c),_step73;try{for(_iterator73.s();!(_step73=_iterator73.n()).done;){var e=_step73.value;if(e.skipDelay(),"all"/* All */!==t&&e.timerId===t)break;}}catch(err){_iterator73.e(err);}finally{_iterator73.f();}return _this195.zc();});}/**
 ...
 *
 * Do not call this constructor directly. Instead, use {@link getFirestore}.
 */var Fa=/*#__PURE__*/function(_Aa){_inherits(Fa,_Aa);var _super32=_createSuper$1(Fa);/** @hideconstructor */function Fa(t,e,n){var _this196;_classCallCheck$1(this,Fa);_this196=_super32.call(this,t,e,n),/**
 ...
 */var eh=/*#__PURE__*/function(){/** @hideconstructor */function eh(t){_classCallCheck$1(this,eh);this._byteString=t;}/**
     ...
     * @returns true if this `Bytes` object is equal to the provided one.
     */},{key:"isEqual",value:function isEqual(t){return this._byteString.isEqual(t._byteString);}}],[{key:"fromBase64String",value:function fromBase64String(t){try{return new eh(Jt.fromBase64String(t));}catch(t){throw new Q$1(G$1.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t);}}/**
 ...
 *
 * @packageDocumentation
 */!function(t){var e=arguments.length>1&&arguments[1]!==undefined?arguments[1]:!0;!function(t){x$1=t;}(SDK_VERSION),_registerComponent(new Component("firestore",function(t,_ref66){var n=_ref66.options;var s=t.getProvider("app").getImmediate(),i=new Fa(s,new J$1(t.getProvider("auth-internal")),new tt$1(t.getProvider("app-check-internal")));return n=Object.assign({useFetchStreams:e},n),i._setSettings(n),i;},"PUBLIC")),registerVersion(D$1,"3.4.12",t),// BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
...
function _m(t) {
  if (d.logLevel <= LogLevel.DEBUG) {
    ...
    var n = e.map(_);
    d.debug.apply(d, ["Firestore (".concat(f, "): ").concat(t)].concat(_toConsumableArray$1(n)));
  }
}
...
function p(t) {
  if (d.logLevel <= LogLevel.ERROR) {
    ...
    var n = e.map(_);
    d.error.apply(d, ["Firestore (".concat(f, "): ").concat(t)].concat(_toConsumableArray$1(n)));
  }
}
/**
 * @internal
...
function y(t) {
  if (d.logLevel <= LogLevel.WARN) {
    ...
    var n = e.map(_);
    d.warn.apply(d, ["Firestore (".concat(f, "): ").concat(t)].concat(_toConsumableArray$1(n)));
  }
}
/**
 * Converts an additional log parameter to a string representation.
...
var U = /*#__PURE__*/_createClass$1(function U(t, e) {
  _classCallCheck$1(this, U);
...
var G = /*#__PURE__*/_createClass$1(function G(t, e, n) {
...
var K = /*#__PURE__*/_createClass$1(function K(t) {
  ...
  _createClass$1(X, [{
    ...
    value: function fromString() {
      ...
      for (var _i = 0, _t2 = t; _i < _t2.length; _i++) {
        ...
        e.push.apply(e, _toConsumableArray$1(n.split("/").filter(function (t) {
          return t.length > 0;
        })));
      }
...
var pt = /*#__PURE__*/function () {
  function pt() {
    _classCallCheck$1(this, pt);
  }

  _createClass$1(pt, null, [{
    key: "R",
    value: function R() {
...
var fe = /*#__PURE__*/_createClass$1(
/**
...
var ve = /*#__PURE__*/_createClass$1(function ve() {
...
var be = /*#__PURE__*/function (_ve) {
  ...
  function be() {
    _classCallCheck$1(this, be);

    return _super13.apply(this, arguments);
  }

  return _createClass$1(be);
}(ve);
...
var Ee = /*#__PURE__*/function (_ve2) {
  ...
  function Ee(t) {
    ...
    _classCallCheck$1(this, Ee);

    _this15 = _super14.call(this), _this15.elements = t;
    return _this15;
  }

  return _createClass$1(Ee);
}(ve);
...
var Pe = /*#__PURE__*/_createClass$1(function Pe() {
  _classCallCheck$1(this, Pe);
});
/**
...
var Se = /*#__PURE__*/_createClass$1(function Se(t, e) {
  _classCallCheck$1(this, Se);
...
var en = /*#__PURE__*/function (_ref3) {
  ...
  function _class4() {
    _classCallCheck$1(this, _class4);
  }

  return _createClass$1(_class4);
...
var An = /*#__PURE__*/_createClass$1(
/**
...
function Hn(t, e, n) {
  ...
  try {
    return _construct(En, _toConsumableArray$1(e.split(".")))._internalPath;
  } catch (r) {
...
var Ir = /*#__PURE__*/function (_ref8) {
  ...
  function _class5() {
    _classCallCheck$1(this, _class5);
  }

  _createClass$1(_class5, [{
    key: "convertValue",
